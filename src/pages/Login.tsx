        ...
        <form className="flex flex-col gap-3 mt-4" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-0 sm:flex-row sm:items-end sm:gap-4">
            ...
            <div className="flex-1 sm:max-w-[220px]">
              <label className="text-[14px] font-medium text-black mb-1 sm:mb-1 sm:ml-2 font-['Roboto']" htmlFor="role">
                Vai trò
              </label>
              <select
                id="role"
                name="role"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#2196F3] text-[14px] shadow-sm mt-1 sm:ml-2 font-['Roboto'] font-normal"
                value={role}
          ...
          <label className="text-[14px] font-medium text-black mb-1 mt-2 font-['Roboto']" htmlFor="password">
            Mật khẩu
          </label>
          <input
            id="password"
          ...
          <div className="flex items-center justify-between mt-2">
            <span className="text-[15px] text-gray-600 font-['Roboto'] font-normal">Quên mật khẩu?</span>
            <a href="/forget-password" className="text-[15px] font-bold text-[#2196F3] hover:underline font-['Roboto']">Lấy lại mật khẩu</a>
          </div>
        </form>
      </div>
